...
bool AVIS_CLIENT::verif_avis(QString ch){//bech tkhali el avis (QString) min 3 caracteres
   bool test=true;
    int i;
   if(ch.length()<3){
      test=false;
...
bool AVIS_CLIENT::verif_idavis(int i){//bech tkhali el avis (QString) min 3 caracteres
   bool test=true;
   if(i<999){
      test=false;
   }
