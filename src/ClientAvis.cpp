    ...
    ui(new Ui::ClientAvis)
{
    ...
    ui->dateEdit_ajout_client->setCalendarPopup(true);
}
...
void ClientAvis::on_ajouter_clicked()
{
    ...
    if(e.verif_EMAIL(e.get_EMAIL())==false){
       ...
       /* QMessageBox::critical(nullptr, QObject::tr("Ajouter Client"),
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");

                        msgBox.setText("verifier Mail !\n"
       ...
       /* QMessageBox::critical(nullptr, QObject::tr("Ajouter Client"),
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText("CIN doit contenir 8 chiffres !\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText("Nom doit contenir 20 caractéres !\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText(" Prenom doit contenir 20 caractéres !\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
        ...
        if(test)
        {
            QFile file("C:/Users/QT/Desktop/LocationVoiture/Historique/HistoriqueClient.txt");
    ...
    {ui->tabetudiant->setModel(tmpCLIENT.afficher_Clist());//refresh
       ...
       /* QMessageBox::information(nullptr, QObject::tr("Supprimer CLIENT"),
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText("Supprimer CLIENT\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
...
{    QMessageBox msgBox;
    ...
    {ui->tabetudiant->setModel(tmpCLIENT.afficher_Clist());//refresh
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText("Modifier client\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
...
{
    QFile file ("C:/Users/QT/Desktop/LocationVoiture/Historique/HistoriqueClient.txt");//tbadel i chemin
...
void ClientAvis::on_pb_ajouter_5_clicked()
{
    ...
    if(e.verif_avis(e.get_AVISCLIENT())==false)
    {
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");

                        msgBox.setText("3 caracteres min!\n"
                                       "Erreur !.\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
    }
    if(e.verif_idavis(e.get_ID_AVIS())==false){
        /*QMessageBox::critical(nullptr, QObject::tr("Ajouter avis client"),
                              QObject::tr(" Id_AVIS doit contenir 8 chiffres !.\n"
                                          "Click Cancel to exit."), QMessageBox::Cancel);*/
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");

                        msgBox.setText("3 chiffres min!\n"
                                       "Erreur !.\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
        ...
        else
        {
            ...
            QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                            ...
                            msgBox.setText("Ajouter avis client\n"
                                           "Erreur !.\n"
                                           "Click Cancel to exit.");
                            msgBox.setIconPixmap(pix);
                             msgBox.exec();
...
{   QMessageBox msgBox;
    ...
    {ui->tabetudiant_2->setModel(tmpAVIS_CLIENT.afficher());//refresh
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText("Supprimer avis client\n"
                                       "avis client supprimé.\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
    ...
    {ui->tabetudiant_2->setModel(tmpAVIS_CLIENT.afficher());//refresh
       ...
       /* QMessageBox::information(nullptr, QObject::tr("Modifier avis client"),
        ...
        QPixmap pix("C:/Users/QT/Desktop/LocationVoiture/icons/msg.png");
                        ...
                        msgBox.setText("Modifier avis client\n"
                                       "Erreur !.\n"
                                       "Click Cancel to exit.");
                        msgBox.setIconPixmap(pix);
                         msgBox.exec();
