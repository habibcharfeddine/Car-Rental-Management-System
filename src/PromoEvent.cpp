...
void PromoEvent::on_pushButton_7_clicked()
{
    ...
    qry.prepare("update PROMOTIONS set NOM_PROMO='"+NOM_PROMO+"' , POURCENTAGE_PROMO='"+POURCENTAGE_PROMO+"' , DATE_DEBUT_PROMO='"+DATE_DEBUT_PROMO+"' , DATE_FIN_PROMO='"+DATE_FIN_PROMO+"'  where ID_PROMO='"+ID_PROMO+"'");
    if (qry.exec())
           {
        ui->tableView_2->setModel(tmppromo.afficher_promotion());
